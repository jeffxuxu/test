...
#define FLASH_COM_CFG_IOT_SERVER_INTERVAL	(0x51)
#define FLASH_COM_CFG_IOT_SERVER_INTERVAL_LEN	(0x2)


#define FLASH_COM_CFG_IOT_SERVER_DOMAIN		(0x53)
#define FLASH_COM_CFG_IOT_SERVER_DOMAIN_LEN		(0x40)   //128 Bytes

#define FLASH_COM_CFG_RESERVE_3				(0x93)
#define FLASH_COM_CFG_RESERVE_3_LEN				(0x14)

#define FLASH_COM_CFG_CMD_PWD				(0xA7)
#define FLASH_COM_CFG_CMD_PWD_LEN				(PASSWORD_MAX_LEN)

#define FLASH_COM_CFG_RESERVE_4				(0xB7)
...
#define	FLASH_STA_CFG_FOTA_STEP	(0x6A)
#define FLASH_STA_CFG_FOTA_STEP_LEN	(0x01)

#define FLASH_STA_CFG_FOTA_VERNUMBER	(0x6B)
#define FLASH_STA_CFG_FOTA_VERNUMBER_LEN	(0x01)

#define FLASH_STA_CFG_FOTA_CRC32VALUE		(0x6C)
#define FLASH_STA_CFG_FOTA_CRC32VALUE_LEN		(0x02)

#define	FLASH_STA_CFG_FOTA_IMAGESIZE	(0x6E)
#define FLASH_STA_CFG_FOTA_IMAGESIZE_LEN	(0x04)

#define FLASH_STA_CFG_FOTA_DO			(0x73)
#define FLASH_STA_CFG_FOTA_DO_LEN		(0x01)

#define FLASH_STA_CFG_FOTA_VERCODE		(0x74)
#define FLASH_STA_CFG_FOTA_VERCODE_LEN	(0x0C)

#define FLASH_STA_CFG_FOTA_NOTIFYIP		(0x80)
#define FLASH_STA_CFG_FOTA_NOTIFYIP_LEN	(0x04)

#define FLASH_STA_CFG_FOTA_NOTIFYPORT		(0x84)
#define FLASH_STA_CFG_FOTA_NOTIFYPORT_LEN	(0x02)

#define FLASH_STA_CFG_FOTA_RESULT		(0x86)
#define FLASH_STA_CFG_FOTA_RESULT_LEN	(0x01)


#define FLASH_STA_CFG_RESERVE_2			(0x87)
#define FLASH_STA_CFG_RESERVE_2_LEN			(0x0)
...
#define FLASH_USR_CFG_VENDOR_ID		(0x1)
#define FLASH_USR_CFG_VENDOR_ID_LEN 		(0x10)  //32 Byte

#define FLASH_USR_CFG_VENDOR_NAME		(0x11)
#define FLASH_USR_CFG_VENDOR_NAME_LEN 		(0x20)  //32 Byte

#define FLASH_USR_CFG_PRODUCT_TYPE		(0x31)
#define FLASH_USR_CFG_PRODUCT_TYPE_LEN 		(0x10)  //32 Byte

#define FLASH_USR_CFG_PRODUCT_NAME		(0x41)
#define FLASH_USR_CFG_PRODUCT_NAME_LEN 		(0x20)  //32 Byte


#define	FLASH_USR_CFG_DEVICE_ID			(0x61)
#define FLASH_USR_CFG_DEVICE_ID_LEN		(0x20)

#define FLASH_USR_CFG_RESERVE_1			(0x81)
#define FLASH_USR_CFG_RESERVE_1_LEN 		(0x0)


#define FLASH_USR_CFG_OUTLETCODING		(0x81)
#define FLASH_USR_CFG_OUTLETCODING_LEN		(0x02)

#define	FLASH_USR_CFG_GROUP				(0x83)
#define FLASH_USR_CFG_GROUP_LEN				(0x01)

#define FLASH_USR_CFG_MEMBER			(0x84)
#define FLASH_USR_CFG_MEMBER_LEN			(0x20)

#define FLASH_USR_CFG_LIGHTTYPE			(0xA4)
#define FLASH_USR_CFG_LIGHTTYPE_LEN			(0x20)

#define FLASH_USR_CFG_RESERVE_2			(0xC4)
#define FLASH_USR_CFG_RESERVE_2_LEN 		(0x0)


#define FLASH_USR_CFG_RULEID			(0x100)
#define FLASH_USR_CFG_RULEID_LEN			(0x02)

#define FLASH_USR_CFG_RULEVALUE			(0x102)
#define FLASH_USR_CFG_RULEVALUE_LEN			(0x40)

#define FLASH_USR_CFG_RULETODO			(0x142)
#define FLASH_USR_CFG_RULETODO_LEN			(0x40)

#define FLASH_USR_CFG_RULEPERIOD        (0x182)
#define FLASH_USR_CFG_RULEPERIOD_LEN		(0x10)

#define FLASH_USR_CFG_RESERVE_3			(0x192)
#define FLASH_USR_CFG_RESERVE_3_LEN 		(0x0)

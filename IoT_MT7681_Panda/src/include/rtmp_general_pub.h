...
typedef struct _TX_BLK_
{
	...
	UCHAR				HeaderBuf[152];				// jinchuan.bao if probe reponse length >127 (include WPA, RSN IE). the RSN IE is incorrect in the air
...
#define PHY_11B                         1
#define PHY_11A                         2
#define PHY_11ABG_MIXED                 3
#define PHY_11G                         4
#define PHY_11ABGN_MIXED                5
#define PHY_11N                         6
#define PHY_11GN_MIXED                  7
#define PHY_11AN_MIXED                  8
#define PHY_11BGN_MIXED                 9
#define PHY_11AGN_MIXED                 10
#define PHY_11N_5G                      11
#define PHY_11VHT                       12,	/* 12 -> 11 ac-only in 5G band */
#define PHY_11VHT_N_MIXED               13, /* 13 -> AC/AN mixed in 5G band */
#define PHY_11VHT_N_A_MIXED             14, /* 14 -> AC/AN/A mixed in 5G band */
#define PHY_11VHT_N_AG_MIXED            15, /* 15 -> AC/A/AN/G/GN mixed  */
#define PHY_11VHT_N_ABG_MIXED           16, /* 16 -> AC/A/AN/B/G/GN mixed */
...
/*
	...
	========================================================================
*/
extern BOOLEAN STARxDoneInterruptHandle(pBD_t pBufDesc);
...
========================================================================
	...
	Arguments:
		pPacket 	Pointer to send packet (mac802_3 + payload)
	...
	========================================================================
*/
extern int STA_Legacy_Frame_Tx(pBD_t PktBuff,  UINT16  PacketLen, BOOLEAN	bClearFrame) XIP_ATTRIBUTE(".xipsec0");
...
*/
#ifdef CONFIG_SOFTAP
extern int AP_Legacy_Frame_Forward_Tx(RX_BLK* pRxBlk, BOOLEAN bClearFrame) XIP_ATTRIBUTE(".xipsec0");
#endif

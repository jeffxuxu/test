    ...
    INOUT  UINT *CipherTextLength)
{
	...
	//if(LastBlockSize > 0)    //jinchuan delete as the padding area in CipherText is not correct, it will cause outputting incorrect plaintext length when do CBC decrypt
